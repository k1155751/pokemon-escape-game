    ...
    questions: [
        {
          ...
          options: ["모든 학생의 의견을 동등하게 존중한다", "성적이 낮은 학생의 의견을 무시한다", "다수의 의견이면 소수의 생각을 배제한다", "교사의 지시라면 이유를 묻지 않는다"],
          answer: 0 // 1번
        },
        {
        ...
        },
        {
          ...
          options: ["활동에서 제외한다", "참여를 제한해 사고를 막는다", "필요한 지원을 제공한다", "같은 기준을 그대로 적용한다"],
          answer: 2 // 3번
        },
        {
          q: "다음 중 편견에 해당하는 생각은?",
          options: ["노력하면 발전할 수 있다", "한 번 실수한 학생은 항상 실수한다", "사람마다 능력은 다르다", "서로 다른 점을 인정해야 한다"],
          answer: 1 // 2번
        },
        {
          q: "다문화 가정 학생을 놀리는 행동이 부당한 이유는?",
          options: ["개인의 배경을 이유로 차별하기 때문에", "학교 분위기를 흐리기 때문에", "규칙 위반이기 때문에", "교사가 금지했기 때문에"],
          answer: 0 // 1번
        },
        {
        ...
        },
        {
          ...
          options: ["말 잘하는 학생만 발언한다", "교사의 생각만 따른다", "다양한 의견을 존중한다", "소수 의견은 무시한다"],
          answer: 2 // 3번
        }
    ]
  },
  {
    ...
    questions: [
        ...
        },
        {
          ...
          options: ["의견을 말할 기회를 제한한다", "규칙에 따라 생활한다", "역할을 공정하게 나눈다", "서로 배려하며 행동한다"],
          answer: 0 // 1번
        },
        {
        ...
        },
        {
          ...
          options: ["갈등과 소외를 만든다", "규칙을 잘 지키게 한다", "학습 효과를 높인다", "질서를 유지한다"],
          answer: 0 // 1번
        },
        {
        ...
        },
        {
          ...
          options: ["엄격할수록 좋다", "학생의 권리를 고려해 만든다", "교사의 판단만 따른다", "처벌 중심으로 운영한다"],
          answer: 1 // 2번
        },
        {
          q: "다음 중 평등과 공정에 대한 설명으로 옳은 것은?",
          options: ["공정은 상황을 고려한 대우이다", "평등은 항상 똑같은 결과물만 나누는 것이다", "공정은 차별을 의미한다", "평등은 개인 차이를 무시한다"],
          answer: 0 // 1번
        },
        {
        ...
        },
        {
          ...
          options: ["친구의 어려움을 무시한다", "타인의 입장을 생각한다", "부당함을 느끼지 못한다", "다수의 의견만 따른다"],
          answer: 1 // 2번
        }
    ]
  },
    ...
    questions: [
        {
          ...
          options: ["소문을 그대로 믿는다", "한 번의 모습으로 판단한다", "차이를 문제로 본다", "다양한 경험과 대화를 나눈다"],
          answer: 3
        },
        {
        ...
        },
        {
          ...
          options: ["문제를 개인 문제로 본다", "공동체가 함께 해결하려 한다", "당사자에게 참으라고 한다", "모른 척한다"],
          answer: 1
        },
        {
        ...
        },
        {
          ...
          options: ["서로의 권리를 존중한다", "소수의 목소리를 무시한다", "문제를 숨긴다", "경쟁을 강화한다"],
          answer: 0
        },
        {
  ...
  },
  {
    ...
    questions: [
        ...
        },
        {
          ...
          options: ["배경을 이유로 배제한다", "개인 차이를 고려한다", "필요에 따라 지원을 제공한다", "참여 기회를 보장한다"],
          answer: 0
        },
        {
        ...
        },
        {
          ...
          options: ["위대하신 도덕 선생님을 위해", "규칙을 강화하기 위해", "처벌을 늘리기 위해", "모두가 존중받는 공동체를 만들기 위해"],
          answer: 3
        }
      ]
  }
