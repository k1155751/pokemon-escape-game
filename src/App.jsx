...
const stages = [
  {
    ...
    bgColor: "bg-green-50",
    pokemonImg: "https://img.pokemondb.net/sprites/home/normal/pikachu.png",
    pokemonName: "피카츄",
    ...
    questions: [
        {
          q: "다음 중 학생의 인권을 존중하는 태도로 가장 적절한 것은?",
          options: ["성적이 낮은 학생의 의견을 무시한다", "다수의 의견이면 소수의 생각을 배제한다", "모든 학생의 의견을 동등하게 존중한다", "교사의 지시라면 이유를 묻지 않는다"],
          answer: 2
        },
        {
          q: "친구의 외모를 놀리는 행동이 문제가 되는 이유로 가장 적절한 것은?",
          options: ["학교 규칙을 어기기 때문에", "상대의 인권과 존엄성을 침해하기 때문에", "갈등이 생길 수 있기 때문에", "교사가 싫어하기 때문에"],
          answer: 1
        },
        {
          q: "다음 중 평등의 의미를 가장 잘 나타낸 것은?",
          options: ["모두에게 똑같은 결과를 주는 것", "상황과 필요를 고려하지 않는 것", "개인의 차이를 존중하며 대하는 것", "다수에게 유리하게 대하는 것"],
          answer: 2
        },
        {
          q: "체육 활동에서 특정 학생만 계속 제외하는 것은 어떤 문제와 가장 관련 깊은가?",
          options: ["책임", "배려", "차별", "경쟁"],
          answer: 2
        },
        {
          q: "장애가 있는 학생을 배려하기 위한 학교의 조치로 가장 적절한 것은?",
          options: ["같은 기준을 그대로 적용한다", "참여를 제한해 사고를 막는다", "필요한 지원을 제공한다", "활동에서 제외한다"],
          answer: 2
        },
        {
          q: "다음 중 편견에 해당하는 생각은?",
          options: ["사람마다 능력은 다르다", "한 번 실수한 학생은 항상 실수한다", "노력하면 발전할 수 있다", "서로 다른 점을 인정해야 한다"],
          answer: 1
        },
        {
          q: "다문화 가정 학생을 놀리는 행동이 부당한 이유는?",
          options: ["학교 분위기를 흐리기 때문에", "규칙 위반이기 때문에", "개인의 배경을 이유로 차별하기 때문에", "교사가 금지했기 때문에"],
          answer: 2
        },
        {
          q: "학교에서 인권이 중요한 이유로 가장 적절한 것은?",
          options: ["규칙을 잘 지키게 하기 위해", "성적을 높이기 위해", "모두가 존중받는 환경을 만들기 위해", "처벌을 줄이기 위해"],
          answer: 2
        },
        {
          q: "다음 중 차별에 해당하지 않는 것은?",
          options: ["이유 없이 특정 학생을 배제한다", "성별을 이유로 역할을 제한한다", "필요에 따라 추가 지원을 제공한다", "배경을 이유로 기회를 제한한다"],
          answer: 2
        },
        {
          q: "학생 자치 활동에서 바람직한 태도는?",
          options: ["말 잘하는 학생만 발언한다", "소수 의견은 무시한다", "다양한 의견을 존중한다", "교사의 생각만 따른다"],
          answer: 2
        }
      ]
  },
  {
    ...
    bgColor: "bg-blue-50",
    pokemonImg: "https://img.pokemondb.net/sprites/home/normal/suicune.png",
    pokemonName: "스이쿤",
    ...
    questions: [
        {
          q: "친구가 성적이 낮다는 이유로 무시당할 때 가장 바람직한 행동은?",
          options: ["상황을 지켜본다", "함께 무시한다", "문제임을 알리고 중단을 요구한다", "관련이 없다고 생각한다"],
          answer: 2
        },
        {
          q: "다음 중 학교에서의 인권 침해 사례로 볼 수 있는 것은?",
          options: ["규칙에 따라 생활한다", "의견을 말할 기회를 제한한다", "역할을 공정하게 나눈다", "서로 배려하며 행동한다"],
          answer: 1
        },
        {
          q: "평등한 학급 분위기를 만들기 위한 행동으로 가장 적절한 것은?",
          options: ["친한 친구 위주로 활동한다", "능력이 뛰어난 학생만 인정한다", "서로의 차이를 존중한다", "경쟁을 강화한다"],
          answer: 2
        },
        {
          q: "편견이 학교생활에 미치는 부정적 영향으로 가장 적절한 것은?",
          options: ["규칙을 잘 지키게 한다", "갈등과 소외를 만든다", "학습 효과를 높인다", "질서를 유지한다"],
          answer: 1
        },
        {
          q: "다음 중 차별을 해결하는 방법으로 가장 바람직한 것은?",
          options: ["문제를 덮어 둔다", "차별받는 사람에게 참으라고 한다", "차별이 왜 문제인지 함께 논의한다", "다수의 의견을 따른다"],
          answer: 2
        },
        {
          q: "학생의 인권과 가장 거리가 먼 행동은?",
          options: ["의견을 자유롭게 표현한다", "이유 없이 체벌한다", "존중받을 권리를 인정한다", "안전하게 보호한다"],
          answer: 1
        },
        {
          q: "학교 규칙이 인권을 침해하지 않으려면 어떻게 해야 하는가?",
          options: ["엄격할수록 좋다", "교사의 판단만 따른다", "학생의 권리를 고려해 만든다", "처벌 중심으로 운영한다"],
          answer: 2
        },
        {
          q: "다음 중 평등과 공정에 대한 설명으로 옳은 것은?",
          options: ["평등은 항상 같은 대우이다", "공정은 상황을 고려한 대우이다", "공정은 차별을 의미한다", "평등은 개인 차이를 무시한다"],
          answer: 1
        },
        {
          q: "성별을 이유로 역할을 제한하는 것이 부당한 이유는?",
          options: ["효율이 떨어지기 때문에", "개인의 가능성을 제한하기 때문에", "규칙에 어긋나기 때문에", "불편하기 때문에"],
          answer: 1
        },
        {
          q: "학교에서 인권 감수성이 높은 학생의 모습은?",
          options: ["친구의 어려움을 무시한다", "부당함을 느끼지 못한다", "타인의 입장을 생각한다", "다수의 의견만 따른다"],
          answer: 2
        }
      ]
  },
  {
    ...
    bgColor: "bg-red-50",
    pokemonImg: "https://img.pokemondb.net/sprites/home/normal/zoroark.png",
    pokemonName: "조로아크",
    ...
    questions: [
        {
          q: "다음 중 편견을 줄이는 데 도움이 되는 태도는?",
          options: ["소문을 그대로 믿는다", "한 번의 모습으로 판단한다", "다양한 경험과 대화를 나눈다", "차이를 문제로 본다"],
          answer: 2
        },
        {
          q: "친구의 종교나 신념을 존중하는 행동은?",
          options: ["다수의 생각을 강요한다", "놀림의 대상으로 삼는다", "다름을 인정하고 존중한다", "침묵을 강요한다"],
          answer: 2
        },
        {
          q: "학교에서 차별이 발생했을 때 가장 바람직한 대응은?",
          options: ["당사자에게 참으라고 한다", "문제를 개인 문제로 본다", "공동체가 함께 해결하려 한다", "모른 척한다"],
          answer: 2
        },
        {
          q: "인권을 존중하는 학급의 특징으로 가장 적절한 것은?",
          options: ["경쟁이 매우 강하다", "소수 의견이 배제된다", "서로를 존중한다", "성적이 가장 중요하다"],
          answer: 2
        },
        {
          q: "다음 중 평등한 기회를 보장하는 사례는?",
          options: ["능력에 상관없이 참여를 막는다", "조건에 따라 참여 기회를 제공한다", "특정 학생만 기회를 얻는다", "배경에 따라 기회를 제한한다"],
          answer: 1
        },
        {
          q: "외국인 학생에게 한국어 사용을 이유로 불이익을 주는 것은 무엇에 해당하는가?",
          options: ["배려", "협력", "차별", "공정"],
          answer: 2
        },
        {
          q: "학교 폭력 중 언어폭력이 인권 침해인 이유는?",
          options: ["규칙을 어겨서", "상대의 존엄성을 훼손해서", "갈등이 생겨서", "분위기가 나빠져서"],
          answer: 1
        },
        {
          q: "다음 중 인권 친화적인 학교 문화를 만드는 방법은?",
          options: ["문제를 숨긴다", "소수의 목소리를 무시한다", "서로의 권리를 존중한다", "경쟁을 강화한다"],
          answer: 2
        },
        {
          q: "편견에 근거한 판단의 문제점으로 가장 적절한 것은?",
          options: ["판단이 빨라진다", "공정한 대우가 어렵다", "규칙이 명확해진다", "질서가 유지된다"],
          answer: 1
        },
        {
          q: "학급에서 차별적 발언을 들었을 때 바람직한 행동은?",
          options: ["웃고 넘긴다", "동조한다", "문제임을 지적한다", "자리를 피한다"],
          answer: 2
        }
      ]
  },
  {
    ...
    pokemonImg: "https://img.pokemondb.net/sprites/home/normal/dialga.png",
    pokemonName: "디아루가",
    ...
    questions: [
        {
          q: "다음 중 학생의 인권에 포함되지 않는 것은?",
          options: ["존중받을 권리", "의견을 표현할 권리", "체벌받을 의무", "안전하게 보호받을 권리"],
          answer: 2
        },
        {
          q: "평등한 관계를 해치는 행동은?",
          options: ["서로의 의견을 듣는다", "차이를 인정한다", "우월감을 드러낸다", "협력한다"],
          answer: 2
        },
        {
          q: "차별을 정당화하는 주장으로 가장 부적절한 것은?",
          options: ["전통이기 때문이다", "모두에게 불리하다", "특정 집단을 배제한다", "개인의 권리를 침해한다"],
          answer: 3
        },
        {
          q: "학교에서 인권 교육이 필요한 이유는?",
          options: ["규칙 암기를 위해", "처벌을 줄이기 위해", "서로 존중하는 문화를 만들기 위해", "성적을 올리기 위해"],
          answer: 2
        },
        {
          q: "다음 중 공정한 학급 운영에 가까운 것은?",
          options: ["교사의 판단만 따른다", "일부 학생에게 특혜를 준다", "합리적인 기준을 적용한다", "힘센 학생이 결정한다"],
          answer: 2
        },
        {
          q: "인권 침해 상황을 목격했을 때 바람직한 태도는?",
          options: ["방관한다", "재미로 본다", "문제 해결을 돕는다", "촬영해 공유한다"],
          answer: 2
        },
        {
          q: "학교에서 평등이 실현되었다고 보기 어려운 경우는?",
          options: ["필요에 따라 지원을 제공한다", "개인 차이를 고려한다", "배경을 이유로 배제한다", "참여 기회를 보장한다"],
          answer: 2
        },
        {
          q: "다음 중 차별적 행동이 아닌 것은?",
          options: ["성별로 활동을 제한한다", "장애를 이유로 배제한다", "학습에 필요한 도움을 제공한다", "외모를 이유로 놀린다"],
          answer: 2
        },
        {
          q: "인권과 책임의 관계에 대한 설명으로 옳은 것은?",
          options: ["인권만 있고 책임은 없다", "책임은 인권보다 중요하다", "인권을 존중하려면 책임도 필요하다", "책임은 교사만의 몫이다"],
          answer: 2
        },
        {
          q: "학교에서 인권·평등·차별 문제를 다루는 궁극적인 목적은?",
          options: ["갈등을 없애기 위해", "규칙을 강화하기 위해", "모두가 존중받는 공동체를 만들기 위해", "처벌을 늘리기 위해"],
          answer: 2
        }
      ]
  }
  ...
  const handleStageCompleteClose = () => {
    // 스테이지 점수 초기화
    const wrongCount = 10 - stageScores[activeStage];
    const newScores = [...stageScores];
    newScores[activeStage] = 0;
    setStageScores(newScores);
    
    // 틀린 문제만큼 전체 점수에서 차감
    setScore(score - wrongCount);
    ...
    return (
      <div className="min-h-screen w-full bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-6 flex items-center justify-center">
        <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl p-8">
          ...
          <div className="mb-6">
            <img 
              src={currentStage.pokemonImg} 
              alt={currentStage.pokemonName}
          ...
          {isSuccess ? (
            <>
              ...
              <button
                onClick={handleStageCompleteClose}
            ...
            <>
              <div className="bg-orange-50 p-6 rounded-xl mb-6 border-l-4 border-orange-500">
                <p className="text-orange-900 font-semibold">
                  모든 문제를 맞춰야 암호를 획득할 수 있습니다!<br/>
                  다시 도전해보세요!
                </p>
              </div>
              <button
                onClick={handleStageCompleteClose}
                className="w-full bg-gradient-to-r from-red-600 to-orange-600 text-white py-4 rounded-xl font-bold text-lg hover:from-red-700 hover:to-orange-700 transition-all"
              >
                다시 도전하기
              </button>
            </>
      ...
      <div className="min-h-screen w-full bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900 p-6 flex items-center justify-center">
        <div className="max-w-md w-full bg-white rounded-3xl shadow-2xl p-8">
          ...
          <input
            ...
            placeholder="비밀번호 입력"
            className="w-full p-4 border-2 border-purple-300 rounded-xl mb-4 text-lg text-center font-bold focus:border-purple-500 focus:outline-none"
          />
      ...
      <div className="min-h-screen w-full bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-4 flex items-center justify-center">
        <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl p-8 text-center">
          ...
          <p className="text-xl text-gray-700 mb-6">
            당신의 최종 점수: <span className="font-bold text-purple-600">{score}/40</span>
          </p>
          <div className="bg-purple-50 p-6 rounded-xl mb-6">
            <p className="text-lg text-gray-800 leading-relaxed">
              단순히 문제를 맞혀서가 아닙니다.<br/>
              당신이 포켓몬을 구하며 보여준 배려, 존중, 그리고 정의로운 마음 때문입니다.<br/><br/>
              <span className="text-2xl">⚡ 피카츄가 당신의 어깨 위로 뛰어올랐습니다!</span>
            </p>
          </div>
          <div className="flex items-center justify-center gap-2 text-purple-700 font-bold text-xl">
            <Award className="w-8 h-8" />
            <span>진정한 도덕 마스터</span>
      ...
      <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              ...
              <div className="text-sm text-gray-500">
                이번 스테이지: {stageScores[activeStage]}/10
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-bold">상황</h3>
          </div>
          ...
          <div className="bg-orange-50 p-4 rounded-lg border-l-4 border-orange-500">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-bold text-orange-900">미션</span>
            </div>
            <p className="text-orange-800">{currentStage.mission}</p>
          </div>
        </div>
